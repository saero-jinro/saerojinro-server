package goorm.saerojinro.speaker.api.config;
...
public class SwaggerConfig {
	...
	private List<Server> initializeServers() {
		...
		return List.of(new Server().url(serverUrl).description("SAERO-JINRO SPEAKER (" + activeProfile + ")"));
	}
	...
	private String getDescription() {
		return format("""
				처음처럼 강연자 전용 API, SAERO-JINRO SPEAKER 입니다.
